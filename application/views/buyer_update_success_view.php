<?php  include '_includes/head.php'; ?>
	...
	<div id="main_container">
		...
		<div class="module_960 drop_shadow rounded_corners">
			...
			<p>Your information has been updated. Please <a href="<?php echo base_url(). 'site/account_management_buyer'; ?>">click here</a> to return to the account management page.</p> 
