	...
	<div id="main_container" class="buyers_account my_account">
		...
		<div class="module_960 drop_shadow rounded_corners light_gradient">
			...
			<div class="form">
				...
				<?php echo form_open('auth/update_forgotten_password'); ?>
					...
					<fieldset>
						<legend>Reset Your Password</legend>
							...
							<label>Confirm New Password</label>		<?php echo form_password('password_confirmation',set_value('password_confirmation')); ?>	<?php echo form_error('password_confirmation'); ?><br class="clear_float" />
																	<?php //echo form_hidden('forgotten_password_code', set_value('forgotten_password_code', $forgotten_password_code[0]->forgotten_password_code)); ?>																			
																	<?php echo form_hidden('forgotten_password_code', set_value('forgotten_password_code', $forgotten_password_code)); ?>																			
