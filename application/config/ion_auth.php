...
*/
	...
	$config['tables']['sellers_accounts']	= 'sellers_accounts';
	$config['tables']['buyers_accounts']	= 'buyers_accounts';
	
	/**
	 * Site Title, example.com
	 */
	$config['site_title']		   = "eTradeInBids.com";
	
	/**
	 * Admin Email, admin@example.com
	 */
	$config['admin_email']		   = "admin@etradeinbids.com";
