...
//We added credit_card_validation inside array by Bryan Jang

	    $query = $this->db->select($this->identity_column.', id, password, group_id, account_type, credit_card_validation')
			      ->where($this->identity_column, $identity)
			      ->where('active', 1)
			      ->where($this->ion_auth->_extra_where)
			      ->limit(1)
		...
		if ($result->password === $password)
		{
		    ...
		    /* Josh modifying stored session data to better match new table structure. 
			...
			*/		
		    ...
		    $session_data = array(
					...
					'credit_card_validation' => $result->credit_card_validation
					);
