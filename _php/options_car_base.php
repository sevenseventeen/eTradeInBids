...
<label>Four Wheel ABS Brakes</label>			<label class="radio_label" for="four_wheel_abs_brakes_yes">Yes</label>	<input id="four_wheel_abs_brakes_yes" class="radio_button" type="radio" value="Yes" name="four_wheel_abs_brakes">
											<label class="radio_label" for="four_wheel_abs_brakes_no">No</label>	<input id="four_wheel_abs_brakes_no"  class="radio_button" type="radio" value="No" name="four_wheel_abs_brakes">
											<br class="clear_float">
...
<label>Power Seat</label>					<label class="radio_label" for="power_seats_yes">Yes</label>		<input id="power_seats_yes" class="radio_button" type="radio" value="Yes" name="power_seat">
											<label class="radio_label" for="power_seats_no">No</label>			<input id="power_seats_no"  class="radio_button" type="radio" value="No" name="power_seat">
											<br class="clear_float">
